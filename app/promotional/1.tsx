...
// Página promocional 1 — acessível via banner com href="app://promotional1".
  ...
  return (
    ...
    >
      ...
      <View style={styles.placeholder}>
        <Text style={styles.placeholderText}>Conteúdo promocional 1 (a definir).</Text>
      </View>
    </PromotionalPage>
  );
}
