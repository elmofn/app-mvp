...
import type { SignInHomeBanner } from '@/src/services/auth';
import { fonts } from '@/src/theme/typography';

type Props = {
  banners: SignInHomeBanner[] | undefined;
};

// Carousel de banners promocionais no rodape da home. Template unico
// (foto + gradient overlay) que serve N banners do payload. Quando
// title vem vazio (ver exemplo da API), so renderiza a description.
