...
export const travelshop: Record<SupportedLang, Record<string, any>> = {
  'en-US': {
    ...
    searchHotelsBase: 'Search',
    searchHotelsAccent: 'Hotels',
    searchFlightsBase: 'Search',
    searchFlightsAccent: 'Flights',
  ...
  'pt-BR': {
    ...
    searchHotelsBase: 'Buscar',
    searchHotelsAccent: 'Hotéis',
    searchFlightsBase: 'Buscar',
    searchFlightsAccent: 'Passagens Aéreas',
  ...
  'es-ES': {
    ...
    searchHotelsBase: 'Buscar',
    searchHotelsAccent: 'Hoteles',
    searchFlightsBase: 'Buscar',
    searchFlightsAccent: 'Vuelos',
